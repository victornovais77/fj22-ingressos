...
public class FilmeController {
	...
	public ModelAndView detalhe(@PathVariable Integer id) {
		...
		Optional<DetalhesDoFilme> detalhesoFilme = client.request(filme,DetalhesDoFilme.class);
		
		DetalhesDoFilme filmess = new DetalhesDoFilme();

		System.out.println(filmess.getAtores());

		mv.addObject("sessoes", sessoes);
		mv.addObject("detalhes",detalhesoFilme.orElse(new DetalhesDoFilme()));
